        ...
        <div className="row">
            <div className="DigitalBusinessSection col col-lg-12 col-md-12 col-sm-12" style={{paddingRight: "0"}}>
                ...
                <div className="DigitalBusinessItems">
                    ...
                    <a href="https://newrepublique.com/work/" className="DigitalBusinessLink" target="_blank" rel="noopener noreferrer"><span className="DigitalBusinessLinkText">view related work</span></a>
                </div>
            </div>
        </div>
    );
